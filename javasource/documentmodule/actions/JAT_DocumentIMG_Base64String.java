...
package documentmodule.actions;
...
import documentmodule.proxies.DocumentRichIMG;
...
public class JAT_DocumentIMG_Base64String extends CustomJavaAction<java.lang.Void>
{
	...
	private final java.util.List<documentmodule.proxies.DocumentText> DocumentTextList;
	/** @deprecated use Document.getMendixObject() instead. */
	@java.lang.Deprecated(forRemoval = true)
	private final IMendixObject __Document;
	private final documentmodule.proxies.Document Document;
	...
	)
	{
		...
		this.DocumentTextList = java.util.Optional.ofNullable(_documentTextList)
			...
			.stream()
			.map(documentTextListElement -> documentmodule.proxies.DocumentText.initialize(getContext(), documentTextListElement))
			.collect(java.util.stream.Collectors.toList());
		this.__Document = _document;
		this.Document = _document == null ? null : documentmodule.proxies.Document.initialize(getContext(), _document);
	}
